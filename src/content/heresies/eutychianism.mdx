...
As with Nestorianism, biblical unitarians see the Eutychian puzzle as a problem created by the two-natures framework itself. If you begin with the premise that a divine nature and a human nature must coexist in one person, you inevitably face the question of how they relate — and Eutychianism is one of the ways that question goes wrong. But if Jesus is one person with one (human) nature, empowered and exalted by God, the problem never arises. The Gospels' portrait of a person who is unambiguously human — and who acts with God's authority because God gave it to him — requires no metaphysical balancing act.
